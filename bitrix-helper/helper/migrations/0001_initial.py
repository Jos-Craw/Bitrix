# Generated by Django 4.2.6 on 2023-11-02 10:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='image/profile/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(blank=True, null=True, upload_to='video/%Y/%m/%d/')),
                ('audio', models.FileField(blank=True, null=True, upload_to='audio/%Y/%m/%d/')),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='helper.post')),
            ],
            options={
