    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Department', models.CharField(choices=[('emp', 'Группа измерения акустики и электромагнитных полей'), ('doz', 'Группа дозиметрических')], max_length=50, null=True, verbose_name='Группа/отдел')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('num', models.CharField(max_length=100, verbose_name='Номер заявки')),
                ('name', models.CharField(max_length=100, null=True, verbose_name='Название заявки')),
